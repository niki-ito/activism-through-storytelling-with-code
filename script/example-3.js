...
function preload() {
  bgImage = loadImage("../assets/images/example-3/bg.jpg");
  mgImage = loadImage("../assets/images/example-3/mg.png");

  mgShadow = loadImage("../assets/images/example-3/mg_shadow.png");

  picture1 = loadImage("../assets/images/example-3/img1.jpeg");
  picture2 = loadImage("../assets/images/example-3/img2.jpeg");
  picture3 = loadImage("../assets/images/example-3/img3.png");

  workIcon = loadImage("../assets/images/example-3/icons/work.png");
  toolIcon = loadImage("../assets/images/example-3/icons/tool.png");
  comfortIcon = loadImage("../assets/images/example-3/icons/heart.png");

  cookieSound = loadSound("../assets/audio/example-3/cookie-eating.wav");
  hoverSound = loadSound("../assets/audio/example-3/bip.mp3");
  bgSound = loadSound("../assets/audio/example-3/bg-music.m4a");

  //a more descrete way to load multiple sequential files
  for (let i = 1; i < 6; i++) {
    fg.push(loadImage("../assets/images/example-3/fg_animate/eating" + i + ".png"));
    fgShadow.push(loadImage("../assets/images/example-3/fg_animate/shadow" + i + ".png"));
  }

  for (let i = 1; i < 7; i++) {
    mistLoop.push(loadImage("../assets/images/example-3/mist_loop/mist" + i + ".png"));
  }
}
function setup() {
